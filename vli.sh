              ...
              if [[ -z "\$void_packages_path" ]] ; then
                ...
                while true; do
                  ...
                  if [[ "\$yn" == "n" ]] || [[ "\$yn" == "N" ]] ; then
                    ...
                    su - "\$void_packages_username" --command "git clone \"\$void_packages_repo\" \"\$void_packages_path\" ; echo -e -n \"\nEnabling restricted packages...\n\" ; echo \"XBPS_ALLOW_RESTRICTED=yes\" >> \"\$void_packages_path\"/etc/conf ; echo -e -n \"\nBootstrapping...\n\n\" ; read -n 1 -r -p \"[Press any key to continue...]\" key ; \"\$SHELL\" \"\$void_packages_path\"/xbps-src binary-bootstrap"
